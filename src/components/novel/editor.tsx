        ...
        <EditorRoot>
            <EditorContent
                ...
                editorProps={{
                    ...
                    attributes: {
                        class: cx(`prose prose-lg dark:prose-invert prose-headings:font-title font-default focus:outline-none max-w-full`, 'md:m-5 m-1 focus:outline-none cursor-primary'),
                    },
